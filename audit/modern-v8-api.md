...
|---|---:|---|---|
| `14.7.84` – `14.9.197` | 27 | `objects-h-macro` | `base::OwnedVector<char>` / `DirectHandle` |
| `14.9.205` – `15.0.1240245` | 16 | `objects-inl-cast-traits` | `base::OwnedVector<char>` / `DirectHandle` |
| `15.1.16` – `15.3.25` | 14 | `objects-inl-def-cast-traits` | `base::OwnedVector<char>` / `DirectHandle` |
